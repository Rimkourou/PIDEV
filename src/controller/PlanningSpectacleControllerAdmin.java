...
public class PlanningSpectacleControllerAdmin implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ObservableList<PlanningSpectacle> pf= saleDeCinemaService.afficherPlanningSpectacle(ControllerSalleDeCinemaAdmin.idSalle);
