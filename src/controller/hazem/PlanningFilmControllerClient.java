...
public class PlanningFilmControllerClient implements Initializable {
...
//        System.out.println(ControllerSalleDeCinemaAdmin.idSalle);
        ObservableList<PlanningFilm> pf= saleDeCinemaService.afficherPlanningFilm(ControllerSalleDeCinemaClient.idSalle);
