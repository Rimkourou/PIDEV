    ...
    private void handleButtonAction(ActionEvent event) throws IOException {
        if (event.getSource() == Enter_signin) {
                    ...
                    if (password.length() < 6) {
                        ...
                        //_________________________________________
                            ...
                            if (rs1.next()) {
                                ...
                                mailing.sendMail(txt_email_up.getText(), "THANK YOU FOR YOUR INSCRIPTION \n" + "This is YOUR OTP:   " + hide.getText());
            ...
            if (hide.getText().equals(enterOTP.getText())) {
                ...
                Parent view5;
                view5 = FXMLLoader.load(getClass().getResource("../../GUI/wifek/InterfaceFilm.fxml"));
...
//            sp.Add_users(u); 
    ...
    void login(ActionEvent event) throws IOException {
        ...
        try {
            ...
            if (email.isEmpty() || password.isEmpty()) {
                ...
                currentUser = u.getId();
                if (u.getRole().equals("supeAdmin") && u.getPassword().equals("test")) {
                    Parent view3 = FXMLLoader.load(getClass().getResource("../../GUI/ons/SuperAdmin.fxml"));
                ...
                if (u.getRole().equals("admin")) {
                    Parent view4 = FXMLLoader.load(getClass().getResource("../../GUI/ons/Admin.fxml"));
                ...
                if (u.getRole().equals("membre")) {
                    Parent view5 = FXMLLoader.load(getClass().getResource("../../GUI/wifek/InterfaceFilm.fxml"));
                    Scene scene5 = new Scene(view5);
                    Stage window = (Stage) ((Node) event.getSource()).getScene().getWindow();
                    window.setScene(scene5);
                    window.show();
    ...
    public void forgotPsw(ActionEvent event) throws IOException {
        Parent view4 = FXMLLoader.load(getClass().getResource("../../GUI/ons/GetPassword.fxml"));
        Scene scene4 = new Scene(view4);
        Stage window = (Stage) ((Node) event.getSource()).getScene().getWindow();
        window.setScene(scene4);
        window.show();
