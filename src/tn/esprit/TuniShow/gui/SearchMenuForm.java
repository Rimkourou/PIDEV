...
import tn.esprit.TuniShow.gui.AfficherListProduit;

public class SearchMenuForm extends Form
{
    Form current;
    String search="";
    public ArrayList<Produit> menus = new ArrayList<>();
            ...
            public void actionPerformed(ActionEvent evt) {
                if (tfsearch.getText().length()>0)
                {
                    try {
                        ...
                        new AfficherListProduitsearch(current,search).show();
