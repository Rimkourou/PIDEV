...
public class SpectacleService {
    ...
    public boolean addSpectacle(Spectacle spectacle){
        String url = Statics.BASE_URL  + "api/spectacle/add?titre="+spectacle.getTitre()+
    ...
    public boolean deleteSpectacle(int id){
        String url = Statics.BASE_URL  + "api/spectacle/delete/"+id ; // Add Symfony URL here
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
    ...
    public ArrayList<Spectacle> showAll(){
        String url = Statics.BASE_URL+"api/spectacle/show"; // Add Symfony URL Here
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public boolean editSpectacle(Spectacle spectacle) {
        String url = Statics.BASE_URL  + "api/spectacle/edit?id="+spectacle.getId()+
    ...
    public ArrayList<Spectacle> showOrdered() {
        String url = Statics.BASE_URL+"api/spectacle/showOrdered"; // Add Symfony URL Here
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
