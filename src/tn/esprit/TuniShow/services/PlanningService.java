...
public class    PlanningService {
    ...
    public boolean addPlanning(Planning planning) {
        String url = Statics.BASE_URL + "api/planning/add?titre="+planning.getTitreEvent()+
    ...
    public boolean editPlanning(Planning planning) {
        String url = Statics.BASE_URL + "api/planning/edit?id="+planning.getId()+
    ...
    public boolean deletePlanning(int id){
        String url = Statics.BASE_URL  + "api/planning/delete/"+id ; // Add Symfony URL here
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
    ...
    public ArrayList<Planning> showAll() {
        String url = Statics.BASE_URL + "api/planning/show"; // Add Symfony URL Here
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public ArrayList<Planning> showOrdered() {
        String url = Statics.BASE_URL + "api/planning/showOrdered"; // Add Symfony URL Here
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public ArrayList<Planning> getPlanningBySpectacleName(String titre) {
        ...
        String url = Statics.BASE_URL + "api/planning/get?titre="+titre; // Add Symfony URL Here
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
